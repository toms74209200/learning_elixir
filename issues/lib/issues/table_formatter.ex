defmodule Issues.TableFormatter do
  ...
  identified b each header. That is, each header identifies a column,
  and those columns are extracted and printed from the rows.
  We calculate the width of each column to fit the longest element in that cloumn.
  """
  ...
  @doc """
  Given a list of rows, where each row contains a keyed list of cloumns,
  ...
  @doc """
  Given a list containing sublists, where each sublist contains the data for a cloumn,
  return a list containing the maximum width of each column.
  ## Example
      iex> data =[ [ "cat", "wombat", "elc"], ["mongoose", "ant", "gnu"]]
